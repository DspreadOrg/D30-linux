...
LV_FONT_DECLARE(ali_regular_14)
LV_FONT_DECLARE(ali_middle_14)
LV_FONT_DECLARE(ali_middle_18)
LV_FONT_DECLARE(ali_middle_24)
LV_FONT_DECLARE(ali_middle_36)
LV_FONT_DECLARE(ali_middle_42)
