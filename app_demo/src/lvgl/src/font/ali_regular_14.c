 ...
 * Size: 14 px
 * Bpp: 4
 * Opts: --bpp 4 --size 14 --no-compress --font AlibabaPuHuiTi-3-55-Regular.ttf --range 32-127 --format lvgl -o ali_regular_14.c
 ******************************************************************************/
...
#ifndef ALI_REGULAR_14
#define ALI_REGULAR_14 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ali_regular_14 = {
#else
lv_font_t ali_regular_14 = {
#endif
