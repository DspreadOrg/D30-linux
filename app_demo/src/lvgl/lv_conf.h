...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "osal.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (get_sys_tick())    /*Expression evaluating to current system time in ms*/
